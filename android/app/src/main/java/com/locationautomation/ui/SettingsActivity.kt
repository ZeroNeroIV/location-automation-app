    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        private fun setupDetectionPreferences() {
            ...
            findPreference<Preference>(KEY_PRIORITY)?.apply {
                summary = "Current: ${preferenceManager.sharedPreferences?.getString(KEY_PRIORITY, "High") ?: "High"}"
            ...
            findPreference<Preference>(KEY_DEBOUNCE)?.apply {
                val debounceValue = preferenceManager.sharedPreferences?.getInt(KEY_DEBOUNCE, 30) ?: 30
        ...
        private fun showPriorityDialog() {
            ...
            val currentPriority = preferenceManager.sharedPreferences?.getString(KEY_PRIORITY, "High") ?: "High"
            ...
            AlertDialog.Builder(requireContext())
                ...
                .setSingleChoiceItems(priorities, currentIndex) { dialog, which ->
                    ...
                    preferenceManager.sharedPreferences?.edit()?.putString(KEY_PRIORITY, selected)?.apply()
